...
3. **Audios:** The folder [audios](./audios) contains audio recordings in English, Chinese and Turkish.

   The English recordings come from the [asterisk-tim](https://github.com/paulseward/asterisk-tim) repository on GitHub, courtesy of Paul Seward-Prior.
